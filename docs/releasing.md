...
The newest stable heading in CHANGELOG.md selects the recorded release. Maintainers review and rebase-merge
changes into the default branch. Documentation work under Unreleased does not advance the recorded version.
